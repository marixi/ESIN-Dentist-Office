        ...
        <div id="info">
            ...
            ?>
                <form action="action_edit_profile_info.php" method="post">
                    ...
                    <p> <strong> Name: </p> <input type="text" name="name" value="<?php if (isset($_SESSION['name'])) {
                                                                                        echo $_SESSION['name'];
                                                                                    } else {
                                                                                        echo $auxiliary['name'];
                                                                                    } ?>" required>
                    <p> <strong> Address: </p> <input type="text" name="address" value="<?php if (isset($_SESSION['address'])) {
                                                                                            echo $_SESSION['address'];
                                                                                        } else {
                                                                                            echo $auxiliary['address'];
                                                                                        } ?>" required>
                    <p> <strong> Phone Number: </p> <input type="text" name="phone_number" value="<?php if (isset($_SESSION['phone_number'])) {
                    ...
                    <p> <strong> Username: </p> <input type="text" name="username" value="<?php if (isset($_SESSION['username'])) {
